...
@Component({
  selector: 'gs-event-field-text-area',
  templateUrl: 'event-field-text-area.component.html',
  styleUrls: ['event-field-text-area.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EventFieldTextAreaComponent
